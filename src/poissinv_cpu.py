...
ext_cpu  = load_inline("poissinv_cpu", [poissinv_src_cpu], cuda_sources=[],extra_cflags=['-fopenmp','-DAT_PARALLEL_OPENMP'], verbose=True,extra_ldflags=['-lgomp'])#,build_directory=path_cpu)
